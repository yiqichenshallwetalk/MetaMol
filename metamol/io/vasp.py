...
"""This section of read/write vasp POSCAR file format is inspired by the mbuild
 package under the Molecular Simulation Design Framework (MoSDeF) project"""

def read_poscar(filename, host_obj=None):
